                                ...
                                <div class="col-lg-3 col-md-12">
                                    <div class="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist"
                                        ...
                                        <button class="nav-link active" id="v-pills-1-tab" data-bs-toggle="pill"
                                            ...
                                            aria-controls="v-pills-1" aria-selected="true">Seach</button>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        ...
                                                        <textarea class="form-control h_100" name="text" cols="30" rows="10">{{ $page_home_data->text }}</textarea>
                                                    </div>
                                                    <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="mb-4">
                                                            ...
                                                            <div>
                                                                <select name="job_category_status"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="mb-4">
                                                        <label class="form-label">Status *</label>
                                                        <div>
                                                            <select name="featured_jobs_status"
                                                                class="form-control select2">
                                                                <option value="Show"
