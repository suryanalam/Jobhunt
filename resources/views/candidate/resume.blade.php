        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12">
                    <a href="{{ route('candidate_resume_create') }}" class="btn btn-primary btn-sm mb-2">
                            ...
                            <tbody>
                                ...
                                @foreach ($resumes as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('candidate_resume_edit',$item->id) }}" class="btn btn-warning btn-sm text-white">
