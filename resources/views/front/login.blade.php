...
@section('seo-title',"$page_auth_item->login_page_title")
@section('seo-meta-description',"$page_auth_item->login_page_meta_description")
...
<div class="page-top" style="background-image: url('{{ asset('uploads/banner.jpg') }}')">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h2>{{ $page_auth_item->login_page_heading }}</h2>
            </div>
        </div>
    </div>
</div>
